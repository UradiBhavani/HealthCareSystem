...
<header id="header">
	...
	<div class="box">
		<form action="EditProfileServlet" method="post" onsubmit="return matchPassword()">
			<table>
				<tr>
					<td>User ID: </td><td><input type="text" name ="userId" id="userId" value="<%= userId %>" readonly></td>
				</tr>
				<tr>
					<td>Name: </td><td><input type="text" name="username" id="username" value="<%= user.getUserName() %>"></td>
				</tr>
				<tr>
				<tr>
					<td>Phone Number: </td><td><input type="tel" name="contactNo" id="contactNo" value="<%= user.getContactNo() %>"></td>
				</tr>
				<tr>
					<td>Email: </td><td><input type="email" name="email" id="email" value="<%= user.getEmail() %>"></td>
				</tr>
				<tr>
					<td><input type="submit" name="Edit" id="Edit"></td>

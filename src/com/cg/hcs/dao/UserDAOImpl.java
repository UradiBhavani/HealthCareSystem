...
public class UserDAOImpl implements IUserDAO {
	...
	public Test getTest(String testName, String centerName) {
		...
		Query query = manager
				.createQuery("select * from Test t where t.testName=:testName and t.centerName=:centerName");
	...
	public List<Appointment> getAppointmentStatus(String userId) {
		...
		Query query = manager.createQuery("select * from Appointment a where a.userId=:userId");
